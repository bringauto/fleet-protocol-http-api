...
class DatabaseApi:
    ...
    def connect_to_database(self, connect_to_database_request : Annotated[Optional[ConnectToDatabaseRequest], Field(description="Login data")] = None, **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the connect_to_database_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def connect_to_database_with_http_info(self, connect_to_database_request : Annotated[Optional[ConnectToDatabaseRequest], Field(description="Login data")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method connect_to_database" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['connect_to_database_request'] is not None:
            _body_params = _params['connect_to_database_request']
