...
class Test_Filtering_Sent_Commands_By_Since_Parameter(unittest.TestCase):
    ...
    def setUp(self, mock_timestamp: Mock) -> None:
        ...
        payload_1 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "1"})
        payload_2 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "2"})
        payload_3 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "3"})
        payload_4 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "4"})
...
class Test_Setting_Wait_To_True_When_All_Commands_Are_Filtered_Out_By_Since_Parameter(
    ...
    def setUp(self, mock_timestamp: Mock) -> None:
        ...
        self.payload_1 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "1"})
        self.payload_2 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "2"})
        self.payload_3 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "3"})
        self.payload_4 = Payload(MessageType.COMMAND_TYPE, "JSON", {"command": "4"})
