...
from fleetv2_http_api.impl.controllers import available_cars, send_statuses  # type: ignore
...
class Test_Waiting_For_Available_Cars(unittest.TestCase):
    ...
    def test_waiting_for_single_car_to_become_available(self):
        ...
        def list_cars():
            cars = available_cars(wait=True)
            self.assertEqual(cars[0], [Car(company_name="test_company", car_name="test_car")])
