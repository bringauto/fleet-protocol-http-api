...
class Car(Model):
    ...
    def company_name(self, company_name: str):
        ...
        if company_name is not None and not re.search(r'^[a-z0-9_]+$', company_name):  # noqa: E501
            raise ValueError("Invalid value for `company_name`, must be a follow pattern or equal to `/^[a-z0-9_]+$/`")  # noqa: E501
    ...
    def car_name(self, car_name: str):
        ...
        if car_name is not None and not re.search(r'^[a-z0-9_]+$', car_name):  # noqa: E501
            raise ValueError("Invalid value for `car_name`, must be a follow pattern or equal to `/^[a-z0-9_]+$/`")  # noqa: E501
